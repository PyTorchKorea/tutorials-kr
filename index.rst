...
* 사용자들이 튜토리얼과 연관된 노트북을 Google Colab에서 열어볼 수 있는 기능이 추가되었습니다.
  `이 페이지 <https://tutorials.pytorch.kr/beginner/colab.html>`_ 를 방문하셔서 자세히 알아보세요!
* 각 튜토리얼에는 Jupyter 노트북과 Python 소스코드를 다운로드할 수 있는 링크가 있습니다.
  IPython 또는 Jupyter를 이용하여 대화식으로 실행하시려면 이용해보세요.
