...
# -------
#
# GPU가 없거나 하나 인 경우 30개의 입력과 30개의 출력을 일괄 처리하면 모델이 예상대로 30을 입력받고 30을 출력합니다.
# 하지만 만약 당신이 다수의 GPU를 가지고 있다면, 다음과 같은 결과를 얻을 수 있습니다.
#
# 2 GPUs
# ~~~~~~
#
# 만약 당신이 2개의 GPU를 갖고 있다면, 다음과 같이 표시될 것 입니다:
#
# .. code:: bash
#
#     # on 2 GPUs
...
# -------
#
# DataParallel 은 당신의 데이터를 자동적으로 분할하고 여러 GPU의 다수의 모델에 작업 지시를 합니다. 각 모델이 작업을 완료하면 DataParallel은
