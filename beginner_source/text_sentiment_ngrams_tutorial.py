...
bag of ngrams 피쳐는 지역(local) 단어 순서에 대한 부분적인 정보를 포착하기위해 적용합니다.
...
# --------------------
#
# AG_NEWS 데이터셋은 4개의 라벨이 있고 그에 따른 클래스 수도 4개 입니다.
#
# ::
#
#    1 : World
...
# offsets은 텍스트 텐서에서 개별 시퀀스의 시작 인덱스를 표현하는 구분자들의 텐서이다.
