...
아래 영상이나 `유튜브 <https://www.youtube.com/watch?v=r7QDUPb2dCM>`__  를 통해 따라할 수 있습니다.
...
# 문서 <https://pytorch.org/docs/stable/notes/broadcasting.html>`__  를 참조하세요.
# 
...
# `문서 <https://pytorch.org/docs/stable/torch.html#math-operations>`__  를 참조하세요.
# 
# 텐서를 제자리에서 변경하기
# ~~~~~~~~~~~~~~~~~~~~~~~~~
# 
...
# 자세한 내용은`문서 <https://pytorch.org/docs/stable/torch.html#torch.reshape>`__  를 참조하세요.
# 
