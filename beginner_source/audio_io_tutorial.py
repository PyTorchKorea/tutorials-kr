...
이 튜토리얼은 TorchAudio의 기본적인 I/O API를 사용하여 오디오 데이터를 확인하고, 
PyTorch 텐서로 불러와서 PyTorch 텐서로 저장하는 방법을 보여줍니다.
...
.. 주의::
   ...
   최근 릴리스에서 오디오 I/O에 여러 변경 사항이 계획 및 적용되었습니다. 
   변경 사항의 자세한 내용은 :ref:`Introduction of Dispatcher <dispatcher_migration>`를 참고하세요.
...
# 먼저, 모듈을 가져오고 이 튜토리얼에서 사용할 오디오 파일들을 다운로드합니다. 
#
# .. note::
# .. 참고::
#    When running this tutorial in Google Colab, install the required packages
#    with the following:
#    이 튜토리얼을 Google Colab에서 실행할 때는, 다음 명령어로 필요한 패키지를 설치하세요.
#
#    .. code::
#    .. 명령어::
#
