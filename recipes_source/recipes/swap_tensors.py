...
# 두 개의 파이썬 tensor를 입력받아 서로 교환하는 유틸리티 함수입니다.
...
# ``nn.Module``에의 적용
# ----------------------------
# 이 유틸리티는 Python 객체가 모듈 외부에 있을 때 nn.Module과 관련이 있습니다
# 모듈의 매개변수에 대한 참조를 가지고 있을 때입니다. 만약 nn.Module이
# 자신의 매개변수를 그 자리에서 수정하면, 매개변수에 대한 참조를 가지고 있는 객체는
# 그 변경사항을 볼 수 없게 됩니다. 이에 대한 전형적인 예시는
# nn.Module의 매개변수에 대한 참조를 가지고 있는 옵티마이저입니다.
