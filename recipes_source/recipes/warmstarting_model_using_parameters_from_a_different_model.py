...
접하게 되는 시나리오입니다. 학습된 매개변수를 활용하면 학습 과정을
빠르게 시작(warmstart)할 수 있으며, 그러면 여러분의 모델을 처음부터
훈련시킬 때보다 훨씬 일찍 수렴하리라 기대할 수 있습니다. 이는 활용할
수 있는 매개변수가 얼마 안 될 때에도 마찬가지입니다.
...
# 의 매개변수 키의 이름을 바꿔서, 불러온 모델을 저장하려는 모델의 키와
# 매치되도록 해 주면 됩니다.
# 
