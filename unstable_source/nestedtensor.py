...
# --------
#
# * `Accelerating PyTorch Transformers by replacing nn.Transformer with Nested Tensors and torch.compile <https://docs.tutorials.pytorch.kr/intermediate/transformer_building_blocks.html>`__
