...
See the `Custom Operators Landing Page <https://tutorials.pytorch.kr/advanced/custom_ops_landing_page.html>`_
for more details.
...
# - `the Custom Operators Manual <https://tutorials.pytorch.kr/advanced/custom_ops_landing_page.html#the-custom-operators-manual>`_
#
