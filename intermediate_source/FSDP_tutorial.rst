...
FSDP로 모델을 감싸면, 모델은 다음과 같이 보일 것입니다. 모델이 하나의 FSDP 유닛으로 래핑된 것을 볼 수 있습니다.
...
이 기능을 사용하면 호스트와 디바이스 간 tensor의 빈번한 복사로 인해 학습 속도가 상당히 느려질 수 있지만, 
