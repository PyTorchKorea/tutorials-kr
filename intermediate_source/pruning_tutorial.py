...
최첨단 딥러닝 모델들은 굉장히 많은 수의 파라미터값들로 구성되기 때문에, 쉽게 배포하기가 어렵습니다.
...
소거 기반 신경망 구조 탐색의 일환으로 하위 신경망 모델과 파라미터 값들의 초기화가 운이 좋게 잘 된 
케이스의 ("`lottery tickets <https://arxiv.org/abs/1803.03635>`_") 역할을 연구하기도 합니다.
