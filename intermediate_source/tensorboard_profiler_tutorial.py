...
====================================
번역: 번역자 <https://github.com/woojinsong>_
...
######################################################################
# 그 후 입력데이터를 준비합니다. 이 튜토리얼에서는 CIFAR10 데이터셋을 사용합니다.
...
#   이 예에서는 텐서보드에 대한 결과 파일을 생성하기 위해 ``torch.profiler.tensorboard_trace_handler``를 사용합니다.
