...
이 단계에서는 이 튜토리얼에 필수적인 파이썬 모듈들을 불러오겠습니다.
...
먼저 모델 크기를 확인해보겠습니다. 모델 크기가 상당히 줄어든 것을
볼 수 있습니다(FP32 형식의 모델 크기 : 438MB; INT8 형식의 모델 크기 : 181MB):
...
양자화를 사용했지만, 참고한 논문에서는 대칭 양자화만을 사용했다는 점이 주요한
차이 입니다.
