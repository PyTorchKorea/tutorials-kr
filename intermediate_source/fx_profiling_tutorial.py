...
class ProfilingInterpreter(Interpreter):
    ...
    ######################################################################
    # 다음으로, 우리의 첫 번째 매소드인 ``run()`` 을 덮여 씌웁니다. ``Interpreter`` 의 ``run``
    # 매소드는 모델 실행을 위한 최상위 진입점입니다. 모델의 총 런타임을 기록할 수 있도록
    # 이 매소드를 가로채고자 할 것입니다.
    ...
    # 매소드(``Interpreter`` 매소드를 덮여씌우지 않는 방법)을 정의할 것입니다
...
# 흥미로운 가능성의 세계를 엽니다.
#
# 마지막으로, FX는 여전히 베타 버전이기 때문에, 사용에 관련된 어떤 피드백도
# 기꺼이 귀기울일 것입니다. 파이토치 포럼(https://discuss.pytorch.org/)
