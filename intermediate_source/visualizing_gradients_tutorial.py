...
**번역**: `김규연 <https://github.com/rlarbdus128-sys>`__

이 튜토리얼은 신경망의 어떤 계층에서든 변화도를 추출하고 시각화하는 방법을 설명합니다. 
어떻게 정보가 네트워크의 끝에서 원하는 매개변수까지 흐르는지 점검함으로써 
...
# 설명된 아키텍처와 유사한, MNIST 데이터셋용 네트워크를 구축할 것입니다.
# 
...
######################################################################
# ``nn.Module`` 안에 있는 모델의 논리(logic)와 상태를 감싸두었기 때문에, 
...
# 두 모델을 비교할 수 있도록 각 gradient matrix의 평균 절댓값을 계산합니다.
# 
...
#    
# -  변화도 소실 및 폭 문제를 해결하기 위한 다른 방법에는 어떤 것들이 있을까요?
#    
