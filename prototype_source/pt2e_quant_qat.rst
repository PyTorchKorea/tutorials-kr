...
to the `post training quantization tutorial <https://tutorials.pytorch.kr/prototype/pt2e_quant_ptq.html>`_.
...
`static eager mode post training quantization tutorial <https://tutorials.pytorch.kr/advanced/static_quantization_tutorial.html>`_:
...
`PTQ tutorial <https://tutorials.pytorch.kr/prototype/pt2e_quant_ptq.html>`_.
