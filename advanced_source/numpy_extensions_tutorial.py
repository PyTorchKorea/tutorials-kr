...
# --------------------
#
# 딥 러닝 문헌에서이 레이어는 혼동스럽게도 컨볼 루션이라고하며 실제 연산은 상호 상관입니다.
# (유일한 차이점은 교차 상관의 경우가 아닌 회선에 대해 필터가 뒤집힌다는 것입니다).
#
# 교차 상관이 가중치를 나타내는 필터 (커널)를 갖는 학습 가능한 가중치가있는 계층의 구현.
#
